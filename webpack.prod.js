...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      'process.env.SENTRY_CONFIG': JSON.stringify(process.env.NEXT_PUBLIC_SENTRY_DSN),
      'process.env.SENTRY_RELEASE': JSON.stringify(process.env.VERCEL_GITHUB_COMMIT_SHA),
    }),
